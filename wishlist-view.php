...
<table class="data-table" id="wishlist-table" data-pagination="<?php echo esc_attr( $pagination )?>" data-per-page="<?php echo esc_attr( $per_page )?>" data-page="<?php echo esc_attr( $current_page )?>" data-id="<?php echo ( is_user_logged_in() ) ? esc_attr( $wishlist_meta['ID'] ) : '' ?>" data-token="<?php echo ( ! empty( $wishlist_meta['wishlist_token'] ) && is_user_logged_in() ) ? esc_attr( $wishlist_meta['wishlist_token'] ) : '' ?>">
     <?php $column_count = 2; ?>
                    ...
                    <tr id="yith-wcwl-row-<?php echo $item['prod_id'] ?>" data-row-id="<?php echo $item['prod_id'] ?>">
                        ...
                        <td class="product-add-to-cart">
                            ...
                            <?php if( $show_add_to_cart && isset( $stock_status ) && $stock_status != 'Out' ): ?>
                               <a rel="nofollow" href="<?php echo $product->add_to_cart_url(); ?>"  
                                data-product_id="<?php echo $product->id; ?>"
                                data-product_sku="<?php echo $product->get_sku(); ?>" 
                                class="<?php echo (isset( $class ) ? $class : 'button' ); ?>">
                                <button type="button" title="Add to Cart" class="button btn-cart"><span><span><?php echo $product->add_to_cart_text(); ?></span></span>
                                          </button></a>
                            <?php endif ?>
        ...
        <?php endif ?>
                                <!-- <tr id="item_2">
                                  <td>
                                    <a class="product-image" href="product-detail.html" title="Cras neque metus">
                                      <img src="<?php ; ?>/images/product/113x113/24.jpg" width="113" height="113" alt="Cras neque metus" />
                                    </a>
                                  </td>
                                  <td>
